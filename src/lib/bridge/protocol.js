 ...
 * Allowed page→extension requests: PING, DS_STATUS, DS_SEND, DS_STOP, DS_IDENTITY.
...
const ALLOWED_REQUESTS = new Set([
  ACTION.PING, ACTION.DS_STATUS, ACTION.DS_SEND, ACTION.DS_STOP, ACTION.DS_IDENTITY,
])
