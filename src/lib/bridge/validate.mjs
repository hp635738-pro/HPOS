...
assert(isAllowedRequestAction(ACTION.DS_NEW_CHAT), 'DS_NEW_CHAT is allowed (New chat via visible UI)')
...
assert(ERROR.DEEPSEEK_NEW_CONVERSATION_UNVERIFIED === 'DEEPSEEK_NEW_CONVERSATION_UNVERIFIED', 'new-conversation-unverified error exists')
